    ...
    <div className="flex items-center gap-3">
      ...
      >
        ...
        >
          ...
          `}>
            <svg className="w-3 h-3 text-blue-600 dark:text-purple-600" fill="currentColor" viewBox="0 0 20 20">
      ...
      {label && (
        <label 
          className={`text-sm font-medium text-gray-900 dark:text-white select-none ${disabled ? 'opacity-50' : 'cursor-pointer'}`}
          onClick={() => !disabled && onChange(!checked)}
        >
          {label}
        </label>
