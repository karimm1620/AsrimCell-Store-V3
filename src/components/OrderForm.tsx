...
const OrderForm: React.FC<OrderFormProps> = memo(
  ({ selectedProduct, onSubmit }) => {
    ...
    return (
      <div className="bg-white dark:bg-codashop-card-dark rounded-4xl shadow-glass-xl p-4 sm:p-6 lg:p-8 border border-gray-200 dark:border-white/10 backdrop-blur-xl animate-scale-in">
        <div className="mb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            >
              {isSubmitting ? (
                <>
                  <LoadingSpinner size="sm" variant="trefoil" color="#ffffff" />
                  <span>Memproses...</span>
                </>
              ) : (
